...
5. （代码）对 logits=[2.5,1.8,1.2,0.8,0.3,0.1,0.05,0.02] 用 greedy/temperature=0.7/temperature=1.5/top-k=4/top-p=0.85 五种策略各采样 2000 次，2×3 子图对比频率。

6. （代码）生成 μ=3, σ=1.5 的正态数据 100 个，MLE 估计 μ 和 σ。重复 100 次实验，画 μ̂ 分布直方图（应以 3 为中心）。
