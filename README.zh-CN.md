...
> **副标题**：含习题、Notebook 与可运行代码的 31 章完整教程 —— **专为 Agent 开发者打造的数学实战指南**

[![Chapters](https://img.shields.io/badge/章节-31-blue)](./chapters/)
...
| Function Calling 该用多高温度？ | 采样策略与确定性权衡 | 第 31.5 节 |
...
| **推理部署** | 第 31.5 节 | Function Calling 温度调参与格式稳定性 |
...
- 第 29 章「单头注意力」→ 第 30 章「多头组装」→ 第 31 章「训练与推理」
...
向量 `**x**`、矩阵 `**W**`、转置 `**X**ᵀ`、梯度 `∇**θ**L`——从第 1 章到第 31 章符号永不漂移，读者不会产生"这个符号到底什么意思"的困惑。
...
| **七：Transformer** | 第 29-31 章 | 单头注意力 → 多头组装 → 训练与推理 | ✅ 第 31 章 |
